...
productsRouter.post('/create', upload.single('productPicture'), productsController.store); // URL que contiene la info del producto creado con ADD FORM al enviar
...
productsRouter.put('/:id/edit',  upload.single('productPicture'), productsController.update); // url que va a contener la info enviada por el formulario de EDIT PRODUCT al presionar enviar
